      ...
      <vl-layout>
        <header class="wp-pt-heading">
          ...
          <div class="wp-pt-heading__title-wrapper">
            <vl-title tag-name="h1" class="wp-pt-heading__title">Gemeentenregister</vl-title>
          </div>
              ...
              <vl-grid mod-stacked>
                ...
                <vl-column width="12">
                  ...
                  <vl-typography>
                    ...
                    <p><vl-link href="https://docs.beta.basisregisters.vlaanderen.be/docs/api-documentation.html#tag/Gemeenten" icon="arrow-right-fat" mod-block mod-icon-before>Documentatie</vl-link></p>
                  </vl-typography>
                </vl-column>
              </vl-grid>
            </vl-column>
