              ...
              <vl-grid mod-stacked>
                ...
                <vl-column width="12">
                  ...
                  <vl-typography>
                    ...
                    <p><vl-link href="https://docs.basisregisters.vlaanderen.be/docs/api-documentation.html#tag/Adressen" icon="arrow-right-fat" mod-block mod-icon-before>Documentatie</vl-link></p>
                  </vl-typography>
                </vl-column>
              </vl-grid>
            </vl-column>
