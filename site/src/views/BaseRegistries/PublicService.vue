      ...
      <vl-layout>
        <header class="wp-pt-heading">
          <div class="wp-pt-heading__parent">
            <vl-link to="/informatie" mod-bold>Basisregisters Vlaanderen</vl-link>
          </div>

          <div class="wp-pt-heading__title-wrapper">
            <vl-title tag-name="h1" class="wp-pt-heading__title">Dienstverleningsregister</vl-title>
          </div>
          ...
          <vl-grid>
            <vl-column width="9" width-s="12">
              <div class="wp-pt-heading__content">
                <vl-typography>
                  <vl-introduction>
                    Dit is een <strong>authentieke</strong> bron voor de Vlaamse dienstverlening.
                  </vl-introduction>
                </vl-typography>
              </div>
            </vl-column>
              ...
              <vl-grid mod-stacked>
                ...
                <vl-column width="12">
                  ...
                  <vl-typography>
                    ...
                    <p><vl-link href="https://docs.beta.basisregisters.vlaanderen.be/docs/api-documentation.html#tag/Dienstverleningen" icon="arrow-right-fat" mod-block mod-icon-before>Documentatie</vl-link></p>
                  </vl-typography>
                </vl-column>
              </vl-grid>
            </vl-column>
              ...
              <aside class="wp-pt-side-navigation--sticky" style="top: 120px;">
                <vl-side-navigation title="Op deze pagina">
                  <vl-side-navigation-list>
                    <vl-side-navigation-item href="#doel" text="Doel" />
                    <vl-side-navigation-item href="#status" text="Status" />
                    <vl-side-navigation-item href="#licentie" text="Licentie" />
                    <vl-side-navigation-item href="#documentatie" text="Documentatie" />
                  </vl-side-navigation-list>
                </vl-side-navigation>
              </aside>
            </vl-column>
