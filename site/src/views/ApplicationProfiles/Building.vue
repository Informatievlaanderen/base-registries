      ...
      <vl-layout>
        <header class="wp-pt-heading">
          <div class="wp-pt-heading__parent">
            <vl-link to="/applicatieprofiel" mod-bold>Applicatieprofiel</vl-link>
          </div>
          ...
          <vl-grid>
            <vl-column width="9" width-s="12">
              <div class="wp-pt-heading__content">
                <vl-typography>
                  <vl-introduction>
                    Dit applicatieprofiel definieert een specificatie voor de uitwisseling van <strong>gebouwinformatie</strong> in de context van een gebouwenregister.
                  </vl-introduction>
                </vl-typography>
              </div>
            </vl-column>
              ...
              <vl-grid mod-stacked>
                <vl-column width="12" v-if="!loaded && !error">
                  <div v-vl-align:center>
                    <vl-loader message="Het applicatieprofiel wordt opgevraagd" />
                  </div>
                </vl-column>

                <vl-column width="12" v-if="error">
                  <vl-alert
                    title="Applicatieprofiel ophalen mislukt"
                    content="Er is iets fout gelopen tijdens het ophalen van het applicatieprofiel. Probeer later opnieuw."
                    mod-error />
                </vl-column>
