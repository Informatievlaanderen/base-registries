      ...
      <vl-layout>
        <header class="wp-pt-heading">
          <div class="wp-pt-heading__parent">
            <vl-link to="/opensource-componenten/" mod-bold>Opensource componenten</vl-link>
          </div>
          ...
          <vl-grid>
            <vl-column width="9" width-s="12">
              <div class="wp-pt-heading__content">
                <vl-typography>
                  <vl-introduction>
                    Wat zit er zo allemaal in het opensource component <strong>{{ this.$route.params.repo }}</strong>?
                  </vl-introduction>
                </vl-typography>
              </div>
            </vl-column>
              ...
              <vl-grid mod-stacked>
                <vl-column v-if="!loaded && !error" width="12">
                  <div v-vl-align:center>
                    <vl-loader message="De details voor het opensource component worden opgevraagd" />
                  </div>
                </vl-column>

                <vl-column v-if="error" width="12">
                  <vl-alert
                    title="Details opensource component ophalen mislukt"
                    content="Er is iets fout gelopen tijdens het ophalen van de details voor het opensource component. Probeer later opnieuw."
                    mod-error />
                </vl-column>
                ...
                <vl-column v-if="loaded" id="readme" width="12">
                  <vl-typography>
                    ...
                    <p>Dit opensource component is beschikbaar onder de volgende licentie: <vl-link :href="licenseUrl">{{ license }}</vl-link>.</p>
