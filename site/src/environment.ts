...
export const API_KEY= process.env.VUE_APP_API_KEY || window.API_KEY;
export const BRANCH_CONTENT= window.baseRegistriesBranchContent || process.env.VUE_APP_BRANCH_CONTENT;